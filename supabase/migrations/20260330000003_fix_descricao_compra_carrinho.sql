/*
  # Fix descrições Compra no Carrinho

  ## Problema
  1. Compra inserida via carrinho mostrava "Compra de pontos/milhas" no histórico
     (trigger ignorava o campo observacao da própria compra)
  2. Transferência-Entrada mostrava "Compra no Carrinho" (deveria ser "Recebimento de [origem]")

  ## Correção
  1. trigger_atualizar_estoque_compras: usa COALESCE(NEW.observacao, 'Compra de pontos/milhas')
     → compras do carrinho passam observacao='Compra no Carrinho' pelo frontend
  2. processar_transferencia_destino: v_observacao_destino sempre = 'Recebimento de [origem]'
*/

-- ==========================================
-- 1. COMPRAS: usa observacao da própria compra
-- ==========================================
...
-- ==========================================
-- 2. DESTINO: sempre "Recebimento de [origem]"
-- ==========================================
