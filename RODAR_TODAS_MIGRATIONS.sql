...
-- Clientes policies
DROP POLICY IF EXISTS "Allow all access to clientes" ON clientes;
...
DROP POLICY IF EXISTS "Allow all access to programas_fidelidade" ON programas_fidelidade;
...
-- Lojas policies
DROP POLICY IF EXISTS "Allow all access to lojas" ON lojas;
...
-- Produtos policies
DROP POLICY IF EXISTS "Allow all access to produtos" ON produtos;
...
DROP POLICY IF EXISTS "Allow all access to cartoes_credito" ON cartoes_credito;
...
DROP POLICY IF EXISTS "Allow all access to contas_bancarias" ON contas_bancarias;
...
DROP POLICY IF EXISTS "Allow all access to classificacao_contabil" ON classificacao_contabil;
...
DROP POLICY IF EXISTS "Allow all access to centro_custos" ON centro_custos;
...
DROP POLICY IF EXISTS "Allow anon to read parceiros" ON parceiros;
...
DROP POLICY IF EXISTS "Allow anon to insert parceiros" ON parceiros;
...
DROP POLICY IF EXISTS "Allow anon to update parceiros" ON parceiros;
...
DROP POLICY IF EXISTS "Allow anon to delete parceiros" ON parceiros;
...
DROP POLICY IF EXISTS "Allow anon to read programas" ON programas;
CREATE POLICY "Allow anon to read programas"
  ON programas FOR SELECT
  TO anon, authenticated
  USING (true);

DROP POLICY IF EXISTS "Allow anon to insert programas" ON programas;
CREATE POLICY "Allow anon to insert programas"
  ON programas FOR INSERT
  TO anon, authenticated
  WITH CHECK (true);

DROP POLICY IF EXISTS "Allow anon to update programas" ON programas;
...
DROP POLICY IF EXISTS "Allow anon to delete programas" ON programas;
...
DROP POLICY IF EXISTS "Allow anon to read programas_membros" ON programas_membros;
CREATE POLICY "Allow anon to read programas_membros"
  ON programas_membros FOR SELECT
  TO anon, authenticated
  USING (true);

DROP POLICY IF EXISTS "Allow anon to insert programas_membros" ON programas_membros;
CREATE POLICY "Allow anon to insert programas_membros"
  ON programas_membros FOR INSERT
  TO anon, authenticated
  WITH CHECK (true);

DROP POLICY IF EXISTS "Allow anon to update programas_membros" ON programas_membros;
...
DROP POLICY IF EXISTS "Allow anon to delete programas_membros" ON programas_membros;
...
-- Azul
DROP POLICY IF EXISTS "Allow all access to azul_membros" ON azul_membros;
...
-- Livelo
DROP POLICY IF EXISTS "Allow all access to livelo_membros" ON livelo_membros;
...
-- TAP
DROP POLICY IF EXISTS "Allow all access to tap_membros" ON tap_membros;
...
-- Accor
DROP POLICY IF EXISTS "Allow all access to accor_membros" ON accor_membros;
...
-- KM
DROP POLICY IF EXISTS "Allow all access to km_membros" ON km_membros;
...
-- Pagol
DROP POLICY IF EXISTS "Allow all access to pagol_membros" ON pagol_membros;
...
-- Esfera
DROP POLICY IF EXISTS "Allow all access to esfera_membros" ON esfera_membros;
...
-- Hotmilhas
DROP POLICY IF EXISTS "Allow all access to hotmilhas_membros" ON hotmilhas_membros;
...
-- Coopera
DROP POLICY IF EXISTS "Allow all access to coopera_membros" ON coopera_membros;
...
-- GOv
DROP POLICY IF EXISTS "Allow all access to gov_membros" ON gov_membros;
...
DROP TRIGGER IF EXISTS update_conta_familia_updated_at ON conta_familia;
...
DROP POLICY IF EXISTS "Allow all to view conta_familia" ON conta_familia;
CREATE POLICY "Allow all to view conta_familia"
  ON conta_familia FOR SELECT
  USING (true);

DROP POLICY IF EXISTS "Allow all to insert conta_familia" ON conta_familia;
CREATE POLICY "Allow all to insert conta_familia"
  ON conta_familia FOR INSERT
  WITH CHECK (true);

DROP POLICY IF EXISTS "Allow all to update conta_familia" ON conta_familia;
CREATE POLICY "Allow all to update conta_familia"
  ON conta_familia FOR UPDATE
  USING (true)
  WITH CHECK (true);

DROP POLICY IF EXISTS "Allow all to delete conta_familia" ON conta_familia;
...
DROP POLICY IF EXISTS "Allow all to view conta_familia_membros" ON conta_familia_membros;
CREATE POLICY "Allow all to view conta_familia_membros"
  ON conta_familia_membros FOR SELECT
  USING (true);

DROP POLICY IF EXISTS "Allow all to insert conta_familia_membros" ON conta_familia_membros;
CREATE POLICY "Allow all to insert conta_familia_membros"
  ON conta_familia_membros FOR INSERT
  WITH CHECK (true);

DROP POLICY IF EXISTS "Allow all to update conta_familia_membros" ON conta_familia_membros;
CREATE POLICY "Allow all to update conta_familia_membros"
  ON conta_familia_membros FOR UPDATE
  USING (true)
  WITH CHECK (true);

DROP POLICY IF EXISTS "Allow all to delete conta_familia_membros" ON conta_familia_membros;
...
-- Criar políticas RLS
DROP POLICY IF EXISTS "Allow all to view status_programa" ON status_programa;
CREATE POLICY "Allow all to view status_programa"
  ON status_programa FOR SELECT
  USING (true);

DROP POLICY IF EXISTS "Allow all to insert status_programa" ON status_programa;
CREATE POLICY "Allow all to insert status_programa"
  ON status_programa FOR INSERT
  WITH CHECK (true);

DROP POLICY IF EXISTS "Allow all to update status_programa" ON status_programa;
CREATE POLICY "Allow all to update status_programa"
  ON status_programa FOR UPDATE
  USING (true)
  WITH CHECK (true);

DROP POLICY IF EXISTS "Allow all to delete status_programa" ON status_programa;
...
DROP POLICY IF EXISTS "Anyone can delete usuarios" ON usuarios;
...
-- Cria novas políticas compatíveis com anon
DROP POLICY IF EXISTS "Anyone can read permissoes" ON usuario_permissoes;
...
DROP POLICY IF EXISTS "Anyone can insert permissoes" ON usuario_permissoes;
...
DROP POLICY IF EXISTS "Anyone can update permissoes" ON usuario_permissoes;
...
DROP POLICY IF EXISTS "Anyone can delete permissoes" ON usuario_permissoes;
...
DROP POLICY IF EXISTS "Usuários podem visualizar programas/clubes" ON programas_clubes;
...
DROP POLICY IF EXISTS "Usuários podem criar programas/clubes" ON programas_clubes;
...
DROP POLICY IF EXISTS "Usuários podem atualizar programas/clubes" ON programas_clubes;
...
DROP POLICY IF EXISTS "Usuários podem deletar programas/clubes" ON programas_clubes;
...
-- Políticas RLS
DROP POLICY IF EXISTS "Usuários podem visualizar histórico" ON conta_familia_historico;
...
DROP POLICY IF EXISTS "Usuários podem criar histórico" ON conta_familia_historico;
...
DROP POLICY IF EXISTS "Usuários podem atualizar histórico" ON conta_familia_historico;
...
DROP POLICY IF EXISTS "Anyone can read perfis_usuario" ON perfis_usuario;
CREATE POLICY "Anyone can read perfis_usuario"
  ON perfis_usuario FOR SELECT
  TO authenticated, anon
  USING (true);

DROP POLICY IF EXISTS "Anyone can insert perfis_usuario" ON perfis_usuario;
CREATE POLICY "Anyone can insert perfis_usuario"
  ON perfis_usuario FOR INSERT
  TO authenticated, anon
  WITH CHECK (true);

DROP POLICY IF EXISTS "Anyone can update perfis_usuario" ON perfis_usuario;
...
DROP POLICY IF EXISTS "Anyone can delete perfis_usuario" ON perfis_usuario;
...
DROP POLICY IF EXISTS "Anyone can read perfil_permissoes" ON perfil_permissoes;
CREATE POLICY "Anyone can read perfil_permissoes"
  ON perfil_permissoes FOR SELECT
  TO authenticated, anon
  USING (true);

DROP POLICY IF EXISTS "Anyone can insert perfil_permissoes" ON perfil_permissoes;
CREATE POLICY "Anyone can insert perfil_permissoes"
  ON perfil_permissoes FOR INSERT
  TO authenticated, anon
  WITH CHECK (true);

DROP POLICY IF EXISTS "Anyone can update perfil_permissoes" ON perfil_permissoes;
...
DROP POLICY IF EXISTS "Anyone can delete perfil_permissoes" ON perfil_permissoes;
...
DROP POLICY IF EXISTS "Usuários autenticados podem visualizar documentos" ON parceiro_documentos;
...
DROP POLICY IF EXISTS "Usuários autenticados podem inserir documentos" ON parceiro_documentos;
...
DROP POLICY IF EXISTS "Usuários autenticados podem deletar documentos" ON parceiro_documentos;
...
DROP POLICY IF EXISTS "Usuários podem fazer upload de documentos" ON storage;
...
DROP POLICY IF EXISTS "Usuários podem visualizar documentos" ON storage;
...
DROP POLICY IF EXISTS "Usuários podem deletar documentos" ON storage;
...
DROP POLICY IF EXISTS "Allow all operations on compras" ON compras;
...
DROP POLICY IF EXISTS "Usuários podem visualizar tipos de compra" ON tipos_compra;
...
DROP POLICY IF EXISTS "Usuários podem criar tipos de compra" ON tipos_compra;
...
DROP POLICY IF EXISTS "Usuários podem atualizar tipos de compra" ON tipos_compra;
...
DROP POLICY IF EXISTS "Usuários podem deletar tipos de compra" ON tipos_compra;
...
-- RLS Policies
DROP POLICY IF EXISTS "Users can view all creditos_recorrentes_log" ON creditos_recorrentes_log;
CREATE POLICY "Users can view all creditos_recorrentes_log"
  ON creditos_recorrentes_log FOR SELECT
  TO authenticated
  USING (true);

DROP POLICY IF EXISTS "Users can insert creditos_recorrentes_log" ON creditos_recorrentes_log;
...
DROP POLICY IF EXISTS "Allow all select on estoque_pontos" ON estoque_pontos;
CREATE POLICY "Allow all select on estoque_pontos"
  ON estoque_pontos
  FOR SELECT
  USING (true);

DROP POLICY IF EXISTS "Allow all insert on estoque_pontos" ON estoque_pontos;
CREATE POLICY "Allow all insert on estoque_pontos"
  ON estoque_pontos
  FOR INSERT
  WITH CHECK (true);

DROP POLICY IF EXISTS "Allow all update on estoque_pontos" ON estoque_pontos;
...
DROP POLICY IF EXISTS "Allow all delete on estoque_pontos" ON estoque_pontos;
...
-- Create new policies for custom auth
DROP POLICY IF EXISTS "Allow all select on transferencia_pontos" ON transferencia_pontos;
CREATE POLICY "Allow all select on transferencia_pontos"
  ON transferencia_pontos
  FOR SELECT
  USING (true);

DROP POLICY IF EXISTS "Allow all insert on transferencia_pontos" ON transferencia_pontos;
CREATE POLICY "Allow all insert on transferencia_pontos"
  ON transferencia_pontos
  FOR INSERT
  WITH CHECK (true);

DROP POLICY IF EXISTS "Allow all update on transferencia_pontos" ON transferencia_pontos;
...
DROP POLICY IF EXISTS "Allow all delete on transferencia_pontos" ON transferencia_pontos;
...
DROP TRIGGER IF EXISTS trigger_update_transferencia_pessoas_updated_at ON transferencia_pessoas;
...
DROP POLICY IF EXISTS "Permitir visualizar transferências entre pessoas" ON transferencia_pessoas;
CREATE POLICY "Permitir visualizar transferências entre pessoas"
  ON transferencia_pessoas FOR SELECT
  TO public
  USING (true);

DROP POLICY IF EXISTS "Permitir inserir transferências entre pessoas" ON transferencia_pessoas;
CREATE POLICY "Permitir inserir transferências entre pessoas"
  ON transferencia_pessoas FOR INSERT
  TO public
  WITH CHECK (true);

DROP POLICY IF EXISTS "Permitir atualizar transferências entre pessoas" ON transferencia_pessoas;
...
DROP POLICY IF EXISTS "Permitir deletar transferências entre pessoas" ON transferencia_pessoas;
...
DROP POLICY IF EXISTS "Usuários podem visualizar vendas" ON vendas;
...
DROP POLICY IF EXISTS "Usuários podem visualizar contas a receber" ON contas_receber;
...
DROP POLICY IF EXISTS "Usuários podem atualizar contas a receber" ON contas_receber;
CREATE POLICY "Usuários podem atualizar contas a receber"
  ON contas_receber FOR UPDATE TO public USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "Usuários podem deletar contas a receber" ON contas_receber;
...
DROP POLICY IF EXISTS "Users can view all passagens_emitidas" ON passagens_emitidas;
CREATE POLICY "Users can view all passagens_emitidas"
  ON passagens_emitidas FOR SELECT
  TO authenticated
  USING (true);

DROP POLICY IF EXISTS "Users can insert passagens_emitidas" ON passagens_emitidas;
CREATE POLICY "Users can insert passagens_emitidas"
  ON passagens_emitidas FOR INSERT
  TO authenticated
  WITH CHECK (true);

DROP POLICY IF EXISTS "Users can update passagens_emitidas" ON passagens_emitidas;
...
DROP POLICY IF EXISTS "Users can delete passagens_emitidas" ON passagens_emitidas;
...
-- Políticas RLS
DROP POLICY IF EXISTS "Usuários podem visualizar atividades" ON atividades;
CREATE POLICY "Usuários podem visualizar atividades"
  ON atividades FOR SELECT
  TO authenticated
  USING (true);

DROP POLICY IF EXISTS "Usuários podem inserir atividades" ON atividades;
CREATE POLICY "Usuários podem inserir atividades"
  ON atividades FOR INSERT
  TO authenticated
  WITH CHECK (true);

DROP POLICY IF EXISTS "Usuários podem atualizar atividades" ON atividades;
...
DROP POLICY IF EXISTS "Usuários podem deletar atividades" ON atividades;
...
DROP POLICY IF EXISTS "Permitir acesso total a parceiro_programa_cpfs_controle" ON parceiro_programa_cpfs_controle;
